...
const Card = (props) => {
    ...
    const handleAddToCart = async () => {
        ...
        if (food !== []) {
            if (food.size === size) {
                await dispatch({ type: "UPDATE", id: props.foodItem._id, price: finalPrice })
                return
            }
        ...
        <div>
            <div>
                <div className="card mt-3" style={{ width: "18rem", maxHeight: "360px" }}>
                    <img src={props.foodItem.img} className="card-img-top objectFit" alt="..." style={{ height: "150px", objectFit: "cover" }} />
